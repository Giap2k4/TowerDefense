...
public class QuantityBottle : GapiMonoBehaviour
{
    ...
    [SerializeField] public int quantityDataBoost;
    [SerializeField] public int quantityDataFreeze;
    [SerializeField] public int quantityDataLightning;
    ...
    protected override void Start()
    {
        ...
        txtLevelBoost.text = MainScore.instance.LoadInt("levelBoost", 1).ToString();
        txtLevelFreeze.text = MainScore.instance.LoadInt("levelFreeze", 1).ToString();
        txtLevelLightning.text = MainScore.instance.LoadInt("levelLightning", 1).ToString();
    ...
    public void BoostUse(int count)
    {
        ...
        MainScore.instance.SaveInt("quantityBoost", this.quantityDataBoost);
    ...
    public void FreezeUse(int count)
    {
        ...
        MainScore.instance.SaveInt("quantityFreeze", this.quantityDataFreeze);
    ...
    public void LightningUse(int count)
    {
        ...
        MainScore.instance.SaveInt("quantityLightning", this.quantityDataLightning);
