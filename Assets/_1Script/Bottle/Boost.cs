...
public class Boost : GapiMonoBehaviour
{
    ...
    [SerializeField] public List<Attack> listAttack;
    [SerializeField] public List<Transform> listBuff;

    [SerializeField] public float sumDamager = 2;

    [SerializeField] protected float timeBoost = 7f;
    [SerializeField] protected float timeCount = 0f;

    [SerializeField] public bool checkBoost = false;
