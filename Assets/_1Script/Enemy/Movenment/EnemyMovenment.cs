...
public class EnemyMovenment : GapiMonoBehaviour
{
    ...
    [SerializeField] protected Map1SO mapSO;
    ...
    protected override void Awake()
    {
        ...
        this.mapSO = Resources.Load<Map1SO>("Map");

        posSpawn = new List<Vector3>(this.mapSO.listPos[Convert.ToInt32(ScrollLevel.nameMap) - 1].list);
    }
