...
public class DataInventory : GapiMonoBehaviour
{
    ...
    {
        this.txtLevelBottle.text = MainScore.instance.LoadInt("levelBottle", 0).ToString();
        this.txtParameterBottle.text = MainScore.instance.LoadFloat("parameterBottle", 0).ToString();
        
        this.txtLevelBoost.text = MainScore.instance.LoadInt("levelBoost", 0).ToString();
        this.txtQuantityBoost.text = MainScore.instance.LoadInt("quantityBoost", 0).ToString();
        this.txtParameterBoost.text = "x" + MainScore.instance.LoadFloat("parameterBoost", 0).ToString();

        this.txtLevelFreeze.text = MainScore.instance.LoadInt("levelFreeze", 0).ToString();
        this.txtQuantityFreeze.text = MainScore.instance.LoadInt("quantityFreeze", 0).ToString();
        this.txtParameterFreeze.text = MainScore.instance.LoadFloat("parameterFreeze", 0).ToString() + "s";

        this.txtLevelLightning.text = MainScore.instance.LoadInt("levelLightning", 0).ToString();
        this.txtQuantityLightning.text = MainScore.instance.LoadInt("quantityLightning", 0).ToString();
